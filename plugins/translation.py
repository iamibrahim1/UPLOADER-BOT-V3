...
"""
    ABOUT_TEXT = """
**📛 My Name** : [Uploader Bot 🚀](https://t.me/urluploaderbabe_bot)

**❤️ Channel** : [Join](http://t.me/real13xx)

**🤖 Group** : [Click](https://t.me/+JmXToG-2x_xmZWM0)

**👨 Owner** : [LISA](https://t.me/hater786)
...
"""
    ...
    FORMAT_SELECTION = "<b>Select Your Format 👇\n\n🎥 Video = Upload As Streamble\n\n📂 File =Upload As File\n\n👮‍♂ Powered By :</b> @hater786"
    SET_CUSTOM_USERNAME_PASSWORD = """"""
    NOYES_URL = "@robot URL detected. Please join @real13xx for more bots and get me a fast URL so that I can upload to Telegram, without me slowing down for other users."
    DOWNLOAD_START = "📥 Downloading..."
    UPLOAD_START = "📤 Uploading.."
    RCHD_BOT_API_LIMIT = "size greater than maximum allowed size (50MB). Neverthless, trying to upload."
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry. But, I cannot upload files greater than 2GB due to Telegram API limitations."
    AFTER_SUCCESSFUL_UPLOAD_MSG = " OWNER : Ibrahim 💕\nFor the List of Telegram Bots"
    ...
    SLOW_URL_DECED = "Gosh that seems to be a very slow URL. Since you were screwing my home, I am in no mood to download this file. Meanwhile, why don't you try this:==> join @real13xx for more bots and get me a fast URL so that I can upload to Telegram, without me slowing down for other users."
